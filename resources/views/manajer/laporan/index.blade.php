...
@section('content')
    <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="card shadow border-0" style="margin-top: 60px;">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('index.manajer.lprn') }}" class="row g-3 align-items-end mb-4">
                    <div class="col-md-3">
                ...
                <div class="table-responsive">
                    @if (count($laporan) > 0)
                        <table class="table table-bordered table-striped table-hover align-middle" id="example1">
                            ...
                            <tfoot>
                                <tr class="fw-bold bg-light">
                                    ...
                                    <td class="text-end">{{ number_format($total->rata_rata_suhu, 2) }}</td>
                                    <td class="text-end">{{ number_format($total->rata_rata_ph, 2) }}</td>
                                    <td class="text-end">{{ number_format($total->rata_rata_do, 2) }}</td>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('generate.manajer.lprn', request()->query()) }}" target="_blank"
