...
<nav id="sidebar" class="col-md-2 d-md-block sidebar shadow border 70" style="margin-top: 45px; position: fixed; height: 100%; background-color: #fffcfc; border-radius: 7px;">
    <div class="pt-3">
        @if ($user->role === App\Models\User::ROLE_ADMIN)
            <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                <i class="bi bi-bar-chart-line me-2"></i>
                Dashboard
            </a>
            <a href="{{ route('index.kolam') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                ...
                <div class="accordion-item border-0 bg-transparent">
                    ...
                    <div id="collapsePakan" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
                        <div class="accordion-body py-0 px-0 bg-transparent">
                            <a href="{{ route('index.pakan.Keluar') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan Keluar
                            </a>
                            <a href="{{ route('index.pakan.masuk') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan Masuk
                            </a>
                            <a href="{{ route('index.pakan') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan
                            </a>
                            <a href="{{ route('index.jadwal.pakan') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
            ...
            <a href="{{ route('index.pengguna') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                <i class="bi bi-person-fill-add me-2"></i>
                Tambah Role
            </a>
            <a href="{{ route('index.laporan') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    style="color: #003049; font-size: 11px;">
                    <i class="bi bi-box-arrow-right me-2"></i> Keluar
                </button>
            </form>

        @elseif($user->role === App\Models\User::ROLE_PETUGASKOLAM)
            <a href="{{ route('petugasKolam.dashboard') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                <i class="bi bi-bar-chart-line me-2"></i>
                Dashboard
            </a>
            <a href="{{ route('index.petugas.kolam') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                <i class="bi bi-water me-2"></i>
                Manajemen Kolam
            </a>
            ...
            <div class="accordion" id="sidebarAccordion">
                <div class="accordion-item border-0 bg-transparent">
                    ...
                    <div id="collapsePakan" class="accordion-collapse collapse" data-bs-parent="#sidebarAccordion">
                        <div class="accordion-body py-0 px-0 bg-transparent">
                            <a href="{{ route('index.petugas.PakanKeluar') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan Keluar
                            </a>
                            <a href="{{ route('index.petugas.PakanMasuk') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan Masuk
                            </a>
                            <a href="{{ route('index.petugas.JenisPakan') }}" class="d-flex align-items-center px-3 py-2 text-dark" style="font-size: 11px;">
                                <i class="bi bi-circle me-2"></i> Pakan
                            </a>
                            </a>
                        </div>
        ...
        @elseif($user->role === App\Models\User::ROLE_MANAJER)
            <a href="{{ route('manajer.dashboard') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
                <i class="bi bi-bar-chart-line me-2"></i>
                Dashboard
            </a>
            {{-- <a href="{{ route('index.lprn') }}" class="d-flex align-items-center px-3 py-2" style="font-size: 11px;">
