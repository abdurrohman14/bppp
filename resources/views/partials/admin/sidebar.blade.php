    ...
    <ul class="nav flex-column">
        @if ($user->role === App\Models\User::ROLE_ADMIN)
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('index.panen') }}"><i class="fas fa-tint"></i> Manajemen Panen</a></li>
                ...
                <ul class="nav flex-column ms-3">
                    ...
                    <li><a class="nav-link {{ request()->is('jadwal-pakan*') ? 'active' : '' }}" href="{{ route('index.jadwal.pakan') }}">Jadwal Pakan</a></li>
                </ul>
            </li>
        ...
        @elseif($user->role === App\Models\User::ROLE_PETUGASKOLAM)
            <li class="nav-item"><a class="nav-link" href=""><i class="fas fa-home"></i>
                    Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('index.petugas.kolam') }}"><i class="fas fa-water"></i> Manajemen Kolam</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('index.petugas.spesies') }}"><i class="fas fa-fish"></i> Manajemen Spesies</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('index.petugas.benih') }}"><i class="fas fa-seedling"></i> Penebaran Benih</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('index.petugas.kematian') }}"><i class="fas fa-skull-crossbones"></i> Manajemen
                    Mortalitas</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('index.petugas.kualitasair') }}"><i class="fas fa-tint"></i> Kualitas Air</a></li>
