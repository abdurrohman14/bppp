...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Sanista+One&family=Sedan+SC&family=Roboto:wght@700&display=swap"
        rel="stylesheet">

    <style>
        body {
            background-image: url('{{ asset('assets/img/SFV.jpg') }}');
...
<body>
    ...
    <div class="login-card">
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="mt-3">
                <a href="{{ route('password.request') }}" class="text-white text-decoration-underline small">Lupa
                    Password?</a>
            </div>
        </form>
    </div>
