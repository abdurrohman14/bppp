...
<main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 content">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Edit Data Kolam</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('update.petugas.kolam', $kolam->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namaKolam" name="nama" placeholder="Masukkan Nama Kolam" value="{{ $kolam->nama }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="jumlahIkan" name="jumlah_ikan" placeholder="Masukkan Jumlah Ikan" value="{{ $kolam->jumlah_ikan }}" required>
                </div>
