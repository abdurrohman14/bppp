    ...
    <div class="card shadow border-0" style="min-height: 550px;">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <a href="{{ route('create.petugas.panen') }}" class="btn btn-primary btn-sm">Tambah</a>
                    ...
                    <tbody>
                        @foreach($panen as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.petugas.panen', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('delete.petugas.panen', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
