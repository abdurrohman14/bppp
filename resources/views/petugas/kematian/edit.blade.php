...
@section('content')
    <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 content">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('update.petugas.kematian', $kematian->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_kematian" value="{{ $kematian->tanggal_kematian }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="jumlah_mati" class="form-label">Jumlah Kematian</label>
                        <input type="number" class="form-control" name="jumlah_mati" value="{{ $kematian->jumlah_mati }}" required>
                    </div>
                    <div class="mb-3">
