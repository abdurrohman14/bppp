...
<main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 content">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('update.kolam', $kolam->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('index.kolam') }}" class="btn btn-info me-2 text-white text-decoration-none">Batal</a>
