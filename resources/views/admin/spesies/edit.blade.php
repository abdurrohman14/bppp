                ...
                <form action="{{ route('update.spesies', $spesies->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jenisIkan" name="jenis_ikan"
                            placeholder="Masukkan Jenis Ikan" value="{{ $spesies->jenis_ikan }}">
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                        <div class="form-floating">
                            <textarea class="form-control" name="deskripsi" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">{{ $spesies->deskripsi }}</textarea>
                        </div>
                    </div>
