                            ...
                            <tr>
                                ...
                                <td style="padding-left: 12px;">
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('kualitas_air.edit', $kualitas->id) }}" class="btn btn-warning btn-sm text-white" style="width: 80px;">Edit</a>
                                        <form action="{{ route('kualitas_air.destroy', $kualitas->id) }}" method="POST" style="width: 80px;">
                                            @csrf
                                            @method('DELETE')
