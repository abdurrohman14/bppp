...
<main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 content">
    <div class="card shadow border-0" style="min-height: 550px;">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                <a href="{{ route('create.kematian') }}" class="btn btn-primary btn-sm">Tambah</a>
            </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">Jumlah Mati</th>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 12px;">
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('edit.kematian', $item->id) }}" class="btn btn-warning btn-sm text-white" style="width: 80px;">Edit</a>
                                        <form action="{{ route('delete.kematian', $item->id) }}" method="POST" style="width: 80px;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm w-100" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
